...
class ThemeController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash('success','Theme ajouter avec succcée!');
    ...
    /**
     * @Route("/{idTheme}", name="theme_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idTheme}/edit", name="theme_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, Theme $theme): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success','Theme modifier avec succcée!');
            return $this->redirectToRoute('theme_index');
        }
    ...
    /**
     * @Route("/{idTheme}", name="theme_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Theme $theme): Response
    {
        if ($this->isCsrfTokenValid('delete'.$theme->getIdTheme(), $request->request->get('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('success','Theme supprimer avec succcée!');
