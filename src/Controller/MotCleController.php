...
class MotCleController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash('success','MotClé ajouté avec succcée!');
    ...
    /**
     * @Route("/{idMotCle}", name="mot_cle_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idMotCle}/edit", name="mot_cle_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, MotCle $motCle): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success','MotClé modifié avec succcée!');
    ...
    /**
     * @Route("/{idMotCle}", name="mot_cle_delete", methods={"DELETE"})
     */
    public function delete(Request $request, MotCle $motCle): Response
    {
        if ($this->isCsrfTokenValid('delete'.$motCle->getIdMotCle(), $request->request->get('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('success','MotClé sumprimé avec succcée!');
